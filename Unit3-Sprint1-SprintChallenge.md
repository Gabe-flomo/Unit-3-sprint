...
- What, in your opinion, is an important part of code reviews? That is, what is
  ...
  when others do the same for your code?
	...
	answer: an important part of a code reviw in my opinion is where code could be more simplified.
for example, if someone sent me their code for review and there was a section where they had code that
was 4 lines but could be simplified to 2. I think this is import because it not only makes code neater,
but it also gives the reviewee knowledge on different ways to solve a coding problem.

- We have an awful lot of computers here, and it gets pretty confusing with
  slightly different things running on all of them. How could containers help us
  improve this situation?

	answer: containers help improve this by letting someone package up all their code and dependecies in one place 
so that the code can be easily transported and quickly ran on a different enviornment. Without containers it would be 
much harder to keep up with everything that you want to tranfer from one place to another.
